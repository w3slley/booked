...
--
-- Host: localhost:3306
-- Generation Time: 25-Jun-2019 às 20:38
...
(160, 'Leonardo Da Vinci', NULL),
(161, 'Harry Potter and the philosopher\'s stone', NULL),
(170, 'Crash', NULL),
(171, 'Desvendando a linguagem corporal', NULL),
(172, 'A arte natural da seduÃ§Ã£o', NULL),
(173, 'Hackeando tudo ', NULL),
(174, 'Eu quero ser rico', NULL),
(177, 'Einstein: His life and universe', NULL);
...
(5, 'Jhenifer', 'Rostirolla', 'jheni', 'jheniferostirolla18@gmail.com', '$2y$10$7/QCcdIovceymMZix9G5We6NU0Jy7xNxbkdc.pquBnSVi0MBTESvu', NULL),
(6, 'user', 'user', 'user', 'user@user.com', '$2y$10$obAXU/7sB9.hBbWx1NcZfuKJ7hNGxjXfGgIA0xpG1GCtpJMMY1BgK', NULL);
